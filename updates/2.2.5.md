...
2. Add on the `Config.Keys` the new key which we use: `['L'] = 0x80F28E95`

3. Read the readme file in case you are interested connecting your stable with tp_farming [here](https://github.com/TitansProductions/tp_farming/blob/main/README.md)
