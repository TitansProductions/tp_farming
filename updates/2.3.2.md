...
1. Fixed hoe durability removal functions on VORP and RSG, the previous ones were under testing, thanks to Betiucia and DenStiveGud, we have placed the correct code to be functional for both frameworks. 
## Modified Files:
