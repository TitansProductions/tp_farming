...
1. Added new features on polyzones for supporting jobs (allowing specific jobs to use a zone).
...
If you are interested adding job support for zones, you have to add the new option on `Config.Zones` section.
