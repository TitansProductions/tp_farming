...
1. Fixed an issue related to polyzone zones, when they were enabled, they should bypass the town block system but instead, when creating a zone inside a blocked town, it would not allow the player to plant.
